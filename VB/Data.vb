		...
		Public Shared Function GenerateTestData() As Object
			...
			For Each country As String In countries
				For i As Integer = 0 To 99
					data.Add(New DataRow With {.Country = country, .Sales = rand.NextDouble() * 100 * i, .SalesTarget = rand.NextDouble()* 100 * i, .SalesDate = Date.Now.AddDays(((If(i Mod 2 = 0, -1, 1)) * i) + rand.Next(10, 40))})
				Next i
			Next country
			Return data
		End Function
